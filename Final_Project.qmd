...
#The model predicts the Rings variable based on all other variables in the abalone dataset.
...
# Convert Rings to a binary mature/immature factor
...
# Convert Mature to binary for logistic regression
